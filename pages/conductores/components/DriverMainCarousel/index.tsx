...
export default function DriverMainCarousel() {
        ...
        >
          <Slide
            ...
            image={
              <img
                ...
                src="img/conductor/conductor-banner-2.svg"
                alt=""
              />
            }
            title={
              <img
                ...
                src="img/conductor/conductor-banner-1.svg"
              />
            }
          />
          ...
          <Slide
            ...
            image={
              <img
                className="w-100 main-image"
                src="img/conductor/conductor-banner-3.svg"
                alt=""
              />
            }
            title={
